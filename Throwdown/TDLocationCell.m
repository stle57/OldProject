...
- (void)awakeFromNib {
    ...
    CGRect locationFrame = CGRectMake(self.locationName.frame.origin.x,self.locationName.frame.origin.y,SCREEN_WIDTH-20, 22);
    ...
    CGRect descriptionFrame = CGRectMake(self.descriptionLabel.frame.origin.x, self.descriptionLabel.frame.origin.y,SCREEN_WIDTH-20, 22);
